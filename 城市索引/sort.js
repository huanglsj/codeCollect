$(function(){
        ...
        var initialsOther = $(".initials-other");
        ...
        $(document).on("tap",".initials ul li",function(){
            var _this=$(this);
        ...
        var windowHeight=$(window).height()-$("#template_bottom").height();
        var InitHeight=windowHeight;
//      Initials.height(InitHeight);
        var LiHeight=InitHeight/27;
        var LiOHeight = $(window).height()/27;
        Initials.find('li').height(LiHeight);
        initialsOther.find('li').height(LiOHeight);
//      Initials.find('li').css("line-height",LiHeight);
})
